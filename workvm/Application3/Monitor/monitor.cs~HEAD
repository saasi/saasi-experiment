...
namespace Monitor
{
    class monitor
    {
        ...
        private static double memoryViolationThreshold = 35.0;
        private static double IOViolationThresdhold = 15.0;
        ...
        private static double io_use_old = 0;
