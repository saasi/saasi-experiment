...
namespace Monitor
{
    class Monitor
    {
        ...
        private static BusinessMicroservice businessMicroservice;
        ...
        public static void Main(string[] args)
        {
            ...
            businessMicroservice = new BusinessMicroservice(dockerClient);
         ...
         //   new Thread(monitorBusinessTimeout).Start();
            ...
            //    Console.WriteLine($"IO {ioMicroservice.ActualScale}->{ioMicroservice.ScaleTarget}");
                Console.WriteLine($"Business {businessMicroservice.ActualScale}->{businessMicroservice.ScaleTarget}");
                Console.WriteLine("###########################################");
            }
