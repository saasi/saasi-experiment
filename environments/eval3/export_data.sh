...
$STYX -d $TIME_SPAN 'docker_swarm_service_target_replicas{service_name=~"\\w+_cpu_microservice"}' > $OUTPUT_DIR/scale_cpu.csv
$STYX -d $TIME_SPAN 'docker_swarm_service_target_replicas{service_name=~"\\w+_io_microservice"}' > $OUTPUT_DIR/scale_io.csv
$STYX -d $TIME_SPAN 'docker_swarm_service_target_replicas{service_name=~"\\w+_business_microservice"}' > $OUTPUT_DIR/scale_business.csv
